...
//				int cup = 23;
//				System.out.println("남는 컵케이크 개수는 : " + cup % 4 + "개");
...
//				현재 레벨을 출력하는 코드를 작성하시오.(단, 증감 연산자만 사용할 것)
...
//				평균 점수를 계산하여 출력하는 코드를 작성하시오.(단, 소수점 처리는 하지 않아도 됨)
		
//				int a = 80, b = 90, c = 70, avg;
//				avg = a + b + c;
//				System.out.println("세 점수의 평균은 : " + avg/3);
...
//				}
//				else System.out.println("조건을 만족하지 못함");
				
				int age = 21;
				boolean isRegisterd = true;
				System.out.println(age >= 20 && isRegisterd);
				

//				[문제 9] 계산 순서 주의
//				다음 조건에 따라 점수를 계산하시오.
//				초기 점수는 10 , 3을 곱하고, 5를 더한 뒤 , 3으로 나눈다
//				최종 점수를 출력하는 코드를 작성하시오.

//				int score = 10;
//				System.out.println((score * 3 + 5) /3d); 
				...
				나이가 18세 이상이고, 티켓을 가지고 있으며, VIP가 아닐 경우만 입장 가능
...
//				
//				if(age >= 20 && hasTicket == true && isVIP == false) {
//					System.out.println("입장 가능");
//				}
//				else System.out.println("입장 불가능");
